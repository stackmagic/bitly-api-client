...
p. the lib is published on bintray: https://bintray.com/stackmagic/maven/bitly-api-client

p. to the jcenter repository just add the following to your pom or gradle build script:
