 ...
 */
public class UserClicksExpandedRequest extends MetricsRequest<UserClicksExpandedRequest, UserClicksExpanded> {
	...
	protected Type getTypeForGson() {
		return new TypeToken<ApiResponse<UserClicksExpanded>>() {
		}.getType();
	}
}
