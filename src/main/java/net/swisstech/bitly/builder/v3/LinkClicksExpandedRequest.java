 ...
 */
public class LinkClicksExpandedRequest extends MetricsRequest<LinkClicksExpandedRequest, LinkClicksExpanded> {
	...
	protected Type getTypeForGson() {
		return new TypeToken<ApiResponse<LinkClicksExpanded>>() {
		}.getType();
	}
}
