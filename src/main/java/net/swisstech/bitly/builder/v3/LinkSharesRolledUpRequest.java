 ...
 */
public class LinkSharesRolledUpRequest extends MetricsRolledUpRequest<LinkSharesRolledUpRequest, LinkSharesRolledUpResponse> {

	/**
	 * Create a new request builder
	 * @param accessToken the access token to access the bitly api
	 */
	public LinkSharesRolledUpRequest(String accessToken) {
		super(accessToken);
	}
	...
	protected Type getTypeForGson() {
		return new TypeToken<Response<LinkSharesRolledUpResponse>>() {
		}.getType();
	}
}
